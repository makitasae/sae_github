...
<body>
    ...
    <section class="home-slider-loop-false  inner-page owl-carousel">
        <div class="slider-item" style="background-image: url('../images/niko.jpg');">
            ...
            <div class="row no-gutters">
                <div class="col-md-12">
                    <div class="sched d-block d-lg-flex">
                        ...
                        <div class="text order-1">
                            <h3>ラポールシュー</h3>
                            <span style="display: flex; justify-content:flex-end;">&yen;205(税込)</span>
                            <hr>
                            <p>サクサクの生地にたっぷりのクリームが詰まっています。ボリュームがあるけど、あっさり食べられる。ラポール自慢の一品です。</p>
                            <p class="text-primary h3"></p>
                            <p class="text-primary h3"><a href="about.php">もっと見る</a></p>
                        </div>
                    ...
                    <div class="sched d-block d-lg-flex">
                        <div class="bg-image"
                            style="background-image: url('http://www.kamu-group.com/resources/fruit_cake.jpg');"></div>
                        <div class="text">
                            <h3>フルーツデコレーションケーキ5号</h3>
                            <span style="display: flex; justify-content:flex-end;">&yen;3,218(税込)</span>
                            <hr>
                ...
                <div class="col-md-12">
                    <div class="sched d-block d-lg-flex">
                        ...
                        <div class="text order-1">
                            <h3>スリール（チーズ)</h3>
                            <span style="display: flex; justify-content:flex-end;">&yen;194(税込)</span>
                            <hr>
                            <p>見ただけでつられて笑顔になってしまうラポールオリジナルチーズケーキ。クセが無く、独特の爽やかな味が手土産にも人気です。シリーズでショコラ味もあります。</p>
                            <p class="text-primary h3"></p>
                            <p class="text-primary h3"><a href="about.php">もっと見る</a></p>
                        </div>
                    ...
                    <div class="sched d-block d-lg-flex">
                        ...
                        <div class="text">
                            <h3>タルトスリール</h3>
                            <span style="display: flex; justify-content:flex-end;">&yen;259(税込)</span>
                            <hr>
                            <p>スリール（チーズ）から生まれた焼き菓子。タルトスリールはフランス語で「笑顔のタルト」という意味です。スリール（チーズ）と同じ材料を使って焼き上げたラポールオリジナルの焼き菓子です。現在開発中のため、お披露目は今しばらくお待ちください。
                            </p>
                            <p class="text-primary h3"></p>
                            <p class="text-primary h3"><a href="about.php">もっと見る</a></p>
